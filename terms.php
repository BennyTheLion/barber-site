...
$stmt = $pdo->prepare("SELECT setting_value FROM settings WHERE setting_key='legal_terms_text'");
$stmt->execute();
...
<body>
<div class="site-header"><div class="brand">תקנון האתר</div><a href="index.php" class="icon-btn">✕</a></div>
