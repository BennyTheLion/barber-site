 ...
 */
function send_app_mail($pdo, $toEmail, $toName, $subject, $htmlBody) {
    $result = send_app_mail_verbose($pdo, $toEmail, $toName, $subject, $htmlBody);
    return $result['ok'];
}
 ...
 */
function send_app_mail_verbose($pdo, $toEmail, $toName, $subject, $htmlBody) {
    ...
    try {
        ...
        $fromName = $s['smtp_from_name'] ?: 'LINE.';
